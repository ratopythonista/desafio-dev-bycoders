...
class TypeCrud:
    ...
    def populate(self):
        ...
        transaction_types = [
            ...
            TypeModel(type_id=5, description="Vendas", nature="Entrada", signal="+"),
            TypeModel(type_id=6, description="Recebimento TED", nature="Entrada", signal="+"),
            TypeModel(type_id=7, description="Recebimento DOC", nature="Entrada", signal="+"),
            TypeModel(type_id=8, description="Aluguel", nature="Saída", signal="-")
        ]
